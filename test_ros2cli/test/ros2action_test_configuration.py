...
def get_fibonacci_info_output(*, count_only=False, include_types=False):
    output = [
        'Action: /fibonacci',
        'Action clients: 0',
        'Action servers: 1',
    ...
    if not count_only:
        if include_types:
            output.append('/fibonacci_action_server [action_tutorials/action/Fibonacci]')
        else:
            output.append('/fibonacci_action_server')
    return output
